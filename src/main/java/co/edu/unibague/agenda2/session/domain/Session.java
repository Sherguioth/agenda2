...
public class Session {
    ...
    public Session(String sessionId, String sessionDescription, LocalDateTime sessionDateTime, Schedule sessionSchedule,
                   Place place) {
    ...
    public static Session create(String sessionId, String sessionDescription, LocalDateTime sessionDateTime,
                                 Schedule sessionSchedule, Place place) {
        return new Session(sessionId, sessionDescription, sessionDateTime, sessionSchedule, place);
    }
